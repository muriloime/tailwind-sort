...
This guide covers setting up the tailwind-class-sorter repository on GitHub before publishing to npm.
...
2. Repository name: `tailwind-class-sorter`
...
```bash
gh repo create tailwind-class-sorter \
  --public \
...
# Or using SSH
git remote add origin git@github.com:YOUR_USERNAME/tailwind-class-sorter.git
...
# Or manually visit:
# https://github.com/YOUR_USERNAME/tailwind-class-sorter
```
...
Set homepage to:
```
https://www.npmjs.com/package/tailwind-class-sorter
```
...
1. Go to https://github.com/YOUR_USERNAME/tailwind-class-sorter/releases/new
...
```bash
# Use HTTPS instead
git remote set-url origin https://github.com/YOUR_USERNAME/tailwind-class-sorter.git
...
# 2. git remote add origin https://github.com/YOUR_USERNAME/tailwind-class-sorter.git
